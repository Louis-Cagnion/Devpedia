...
- **Mathematics**: the math vocabulary the AI and Data Science chapters lean on, starting from zero — not even high-school math assumed: the function concept, vectors and the dot product, logarithms, basic probability, and derivatives/gradients
