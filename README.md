...
- **AI**: neural network fundamentals through production LLM systems — gradient descent, CNN/RNN/Transformer architectures, PyTorch, NLP & LLM basics, production use cases and limits, agents, RAG, LLM monitoring, data governance for AI systems, and chatbots
