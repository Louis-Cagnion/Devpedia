...
- Audit structurel `content-br/` vs `content/` (FR, 2026-08-14) : 279 fichiers FR, 125 en BR. **167 fichiers manquants**, répartis sur 14 catégories entièrement absentes (IA 39, PowerShell 14, UI-UX 11, Performance 9, Bases de l'informatique 7, Docker 7, Mathématiques 7, Qualité et architecture du code 7, Zsh 7, Data Science 6, Représentation des données 6, CI-CD 5, Infrastructure 5, Organisation en entreprise 5, Traitement de documents 4) + rattrapages dans des catégories partielles (Langages de programmation 13, Bash 3, Git 3, DSL 1, Shells 1).
- **12 fichiers BR existants sont mal placés/renommés**, pas seulement absents : `architectures-cnn-rnn-transformers.md`, `deep-learning-pytorch.md`, `entrainement-descente-de-gradient.md`, `reseaux-de-neurones.md` (→ `IA/Fondamentaux du deep learning/` en FR), `nlp-et-llm.md` (→ `IA/NLP et LLM/`), `jupyter-notebooks.md`, `machine-learning-scikit-learn.md`, `matplotlib.md`, `numpy.md`, `pandas.md` (→ `Data Science/`) sont encore sous `Langages de programmation/Python/` en BR (catégorie d'origine avant la création d'IA/Data Science) ; `HTMLElements.md` et `structuresDeLangagues.md` gardent l'ancien nommage camelCase corrigé en FR (`html-elements.md`, `structures-de-langage.md`). Contenu globalement plus court que la version FR actuelle (ex : `machine-learning-scikit-learn.md` 6 titres/87 lignes en BR vs 11 titres/170 lignes en FR) : à traiter comme une réécriture depuis la version FR actuelle, pas un simple déplacement de fichier.
