...
- Phrases de la table de prononciation des symboles (`js/reader.js`) à valider mot à mot par Louis : opening tag PHP, heredoc `<<`/`EOF` Git, "to" sur les comparaisons, et le bug `"$(...)"`/`"$((...))"` (Bash/Zsh/PowerShell/Git) faits le 2026-08-15, reste le reste de la table.
