...
- Audit structurel `content-br/` vs `content/` (FR, 2026-08-14) : 279 fichiers FR. **164 fichiers encore manquants** (167 au départ, 3 résorbés par le rattrapage ci-dessous), répartis sur 14 catégories entièrement absentes (IA 37, PowerShell 14, UI-UX 11, Performance 9, Bases de l'informatique 7, Docker 7, Mathématiques 7, Qualité et architecture du code 7, Zsh 7, Data Science 5, Représentation des données 6, CI-CD 5, Infrastructure 5, Organisation en entreprise 5, Traitement de documents 4) + rattrapages dans des catégories partielles (Langages de programmation 13, Bash 3, Git 3, DSL 1, Shells 1).
