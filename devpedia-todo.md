...
- Reste à faire : régénérer l'audio FR des chapitres Git/PHP/PowerShell/Zsh/HTML/CSS/Blockchain/SQL (seul l'accueil a été régénéré pendant les itérations, sur consigne de Louis) ; envisager à cette occasion une régénération complète du site vu l'ampleur des changements de prononciation.
