...
Catégorie créée, 3 chapitres en place (concepts fondamentaux, Solidity bases du langage, déployer et interagir avec un smart contract — faits le 22/08/2026). Traitée en profondeur (plusieurs chapitres à terme, réseaux type Avalanche/backends sur ICP), à trancher en écrivant comme la section Tests.
