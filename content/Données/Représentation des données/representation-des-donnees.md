...
Un programme ne manipule jamais des nombres ou du texte "en soi" : il manipule leur **encodage** en mémoire, sur un nombre fini de bits. Cette contrainte physique produit des comportements qu'on attribue souvent à tort au langage utilisé, alors qu'ils sont communs à tous : `0.1 + 0.2` ne vaut pas exactement `0.3` en [JavaScript](/?c=langages-de-programmation&s=javascript&p=javascript), mais pas davantage en [C](/?c=langages-de-programmation&s=c&p=c), en [Python](/?c=langages-de-programmation&s=python&p=python) ou en [PHP](/?c=langages-de-programmation&s=php&p=php).
