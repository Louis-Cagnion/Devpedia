...
| **Outils utilisables** | Les bibliothèques de vision par ordinateur ([torchvision](https://pytorch.org/vision/stable/index.html), par exemple) fournissent des implémentations de NMS prêtes à l'emploi, plus rapides que du code Python pur sur un grand nombre de boîtes. |
