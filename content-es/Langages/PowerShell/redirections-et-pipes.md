...
```powershell
# PowerShell no tiene un operador "<" directo: se pasa por una cmdlet
...
# atajo de PowerShell: redirige TODOS los flujos hacia todo.log
Comando *> todo.log
```
...
```powershell
# filtra por propiedad, no por texto
