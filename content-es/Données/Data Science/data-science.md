...
Esta sección cubre las herramientas [Python](/?c=langages-de-programmation&s=python&p=python) de la ciencia de datos: manipular grandes volúmenes de datos eficazmente (NumPy, pandas), explorarlos visualmente (Matplotlib, Jupyter), y construir modelos de machine learning clásicos (scikit-learn), en contraposición a las redes neuronales y los LLM, tratados en la sección [IA](/?c=ia).
