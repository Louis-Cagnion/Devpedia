...
| **Herramientas utilizables** | Las bibliotecas de visión por computadora ([torchvision](https://pytorch.org/vision/stable/index.html), por ejemplo) proveen implementaciones de NMS listas para usar, más rápidas que código [Python](/?c=langages-de-programmation&s=python&p=python) puro sobre un gran número de cajas. |
