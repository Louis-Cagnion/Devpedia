...
solde = 100
retirer = 150
solde = solde - retirer   → solde devient -50 : rien n'verified that'il y avait assez d'argent
afficher solde              → affiche -50
```

The code runs without crashing and does exactly what it's written to do—and that's precisely the problem: no one wrote the instruction "reject the withdrawal if the balance is insufficient."
...
Erreur : division par zéro
  à la ligne 4, dans la fonction "calculate_average"
```
