...
afficher "Goodbye"    → écrit "Goodbye" à l'écran juste après
```
...
> **Caution:** Do not try to run the pseudocode above as-is in an actual programming language—it will not work, as it is only a simplified illustration, not actual syntax.
>
