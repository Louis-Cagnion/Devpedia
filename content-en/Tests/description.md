...
The [security testing and auditing](/?c=securite&s=cybersecurite&p=tests-et-audit-de-securite) chapter covers hunting for security vulnerabilities, a different goal from the tests covered here (checking that the program works as intended).
