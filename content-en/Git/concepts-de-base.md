...
| Field | Role |
|---|---|
| **Working folder** | Files as they actually exist on the disk, freely editable |
...
> **Note:** This intermediate staging step is a unique feature of Git compared to older systems (such as SVN); it allows you to precisely select **which** changes are included in a commit, even if multiple files were modified at the same time.
