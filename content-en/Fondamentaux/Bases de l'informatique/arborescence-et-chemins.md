...
> **Analogy:** Just like folders filed away in drawers, which are themselves stored in a cabinet: finding a specific sheet requires knowing the cabinet, the drawer, and then the folder.

> **Pitfall:** Deleting a folder deletes **all** of its contents along with it, including the folders it contains, often without asking for confirmation for each file individually.
>
...
Documents/photos/../travail/rapport.docx
                 └─┬─┘
                   └── goes up one level (leaves "photos"), then back down into "travail"
```
