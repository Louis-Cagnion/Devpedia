...
Any data that enters a prompt (a user's question, a document injected by [RAG](/?c=ia&p=rag), a result from a tool called by an [agent](/?c=ia&p=agents)) deserves to be classified before it's sent, not after:
