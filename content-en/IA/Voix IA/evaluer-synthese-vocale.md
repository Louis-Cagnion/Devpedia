...
[Evaluating an OCR](/?c=ia&s=vision-et-ocr&p=evaluer-un-ocr) compares an output to a known exact reference (the image's actual text). Speech synthesis doesn't have that luxury: there's no single "right answer" for "what a voice should sound like", a question that remains largely subjective.
...
| Below 3 | Distracting audible artifacts (see concatenative synthesis, see [Fundamentals](/?c=ia&s=voix-ia&p=synthese-classique-vs-deep-learning)) |
