...
See also [Architectures — CNN, RNN, and Transformers](/?c=ia&p=architectures-cnn-rnn-transformers): PyTorch provides ready-made layers for each (`nn.Conv2d`, `nn.LSTM`, `nn.TransformerEncoder`...), built on top of the same basic building blocks seen here.
