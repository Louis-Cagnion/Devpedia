...
4. Retour a 2, jusqu'has a criterion of'arret (qualite jugee suffisante,
...
1. Pre-entrainement    -> predire le mot suivant sur un immense corpus
                          de texte (voir NLP et LLM) - le modele "raw"
...
3. RLHF (Reinforcement -> des humains comparent des paires de reponses
   Learning from Human    ("Which one is the best?") ; ces
