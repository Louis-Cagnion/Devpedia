...
- The **weights** (`w1`, `w2`...) determine how important each input is: these, along with the bias, are what training adjusts (see [Model Training and Gradient Descent](/?c=ia&s=fondamentaux-du-deep-learning&p=entrainement-descente-de-gradient)).
...
See also [Model Training and Gradient Descent](/?c=ia&s=fondamentaux-du-deep-learning&p=entrainement-descente-de-gradient) (how these weights are concretely adjusted) and [Architectures: CNNs, RNNs, and Transformers](/?c=ia&s=fondamentaux-du-deep-learning&p=architectures-cnn-rnn-transformers) (specific ways of organizing these layers depending on the type of data processed).
...
| **Tools you can use** | Common activation functions (sigmoid, ReLU, softmax) are provided directly by deep learning libraries (see [PyTorch](/?c=ia&s=fondamentaux-du-deep-learning&p=deep-learning-pytorch)). |
