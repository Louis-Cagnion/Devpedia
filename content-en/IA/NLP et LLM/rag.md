...
- **Too large**, a fragment dilutes its relevance: in a multi-page document, only a portion actually answers the question, but the whole fragment gets injected into the prompt, at a cost (see [LLM in Production](/?c=ia&s=nlp-llm&p=llm-en-production)) and at the risk of drowning the useful information in irrelevant text.
...
>
> **Best practice:** monitor the quality of retrieval itself (were the fragments retrieved actually relevant?), not just the quality of the final answer; see [LLM Monitoring and Operations](/?c=ia&s=production-et-gouvernance&p=gestion-dun-llm).
