...
| Number of input and output tokens | This is the basis of cost (see [LLMs in Production](/?c=ia&p=llm-en-production)) and an anomaly indicator (a prompt that balloons in size for no reason often signals an upstream bug) |
