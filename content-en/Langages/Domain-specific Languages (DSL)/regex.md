...
### Step 3: Assemble the brackets and the group
...
- [Regular Expressions (MDN, Mozilla Developer Network, the web's reference documentation)](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Regular_expressions)
