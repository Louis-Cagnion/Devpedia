...
- Inclusão seguinte (no mesmo arquivo, noutra cadeia de inclusões): `CALCULS_H` já está definido → o pré-processador salta diretamente para `#endif`, o conteúdo não é duplicado.
