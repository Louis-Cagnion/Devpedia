...
| **Ferramentas úteis** | As bibliotecas de visão computacional ([torchvision](https://pytorch.org/vision/stable/index.html), por exemplo) fornecem implementações de NMS prontas para uso, mais rápidas que código Python puro em um grande número de caixas. |
