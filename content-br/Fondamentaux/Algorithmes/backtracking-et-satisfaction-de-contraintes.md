...
> **Nota:** para explorar vários ramos ao mesmo tempo em vários núcleos, ver [Paralelizar uma busca: dividir em subproblemas independentes](/?c=fondamentaux&s=algorithmes&p=recherche-parallele-par-sous-problemes).
