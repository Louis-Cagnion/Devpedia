...
Em CSS, uma paleta de cores se declara como um conjunto de valores reutilizáveis em vez de repetidas a cada regra: veja [Variáveis CSS e a cascata](/?c=langages-de-balisage&s=css&p=variables-et-cascade).
